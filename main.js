...
function searchDb(e){
    ...
    let filteredPhones = db.filter(phone => phone.name.includes(searchTerm) || phone.brand.includes(searchTerm) || phone.store.includes(searchTerm));
